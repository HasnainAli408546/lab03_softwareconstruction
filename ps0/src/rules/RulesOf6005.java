...
public class RulesOf6005 {
	...
	/*public static boolean mayUseCodeInAssignment(boolean writtenByYourself,
	    ...
	    // Incorrect implementation: always return true
	    return true; 
	}
*/
	/*public static boolean mayUseCodeInAssignment(boolean writtenByYourself,
	    ...
	    // Incorrect implementation: return true if not written by yourself
	    // This logic will fail the tests for conditions that should return false.
	...
	*/
    ...
    public static boolean mayUseCodeInAssignment(boolean writtenByYourself,
        ...
        // If the code was written by yourself, you can use it.
        if (writtenByYourself) {
            return true;
        }
        
        // If the code is available to others, you may use it if you cite your source.
        if (availableToOthers && citingYourSource) {
            return true;
        }

        // If the code was written as coursework and implementation is required, you may use it.
    ...
    public static void main(String[] args) {
        ...
        System.out.println("Code available to others and cited: " +
            RulesOf6005.mayUseCodeInAssignment(false, true, false, true, false));
        System.out.println("Code written as coursework and implementation required: " +
            RulesOf6005.mayUseCodeInAssignment(false, false, true, false, true));
        System.out.println("Code not allowed: " +
